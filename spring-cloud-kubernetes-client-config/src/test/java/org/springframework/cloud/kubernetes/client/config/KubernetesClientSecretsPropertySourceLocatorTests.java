...
class KubernetesClientSecretsPropertySourceLocatorTests {
	...
	void getLocateWithOutSources() {
		...
		SecretsConfigProperties secretsConfigProperties = new SecretsConfigProperties(true, Map.of(), List.of(), true,
				"db-secret", "default", false, true, false, RetryProperties.DEFAULT);
	...
	void testLocateWithoutNamespaceConstructor() {
		...
		SecretsConfigProperties secretsConfigProperties = new SecretsConfigProperties(true, Map.of(), List.of(), true,
				"db-secret", "", false, true, false, RetryProperties.DEFAULT);
	...
	void locateShouldThrowExceptionOnFailureWhenFailFastIsEnabled() {
		...
		SecretsConfigProperties secretsConfigProperties = new SecretsConfigProperties(true, Map.of(), List.of(), true,
				"db-secret", "default", false, true, true, RetryProperties.DEFAULT);
