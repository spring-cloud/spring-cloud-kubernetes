...
import org.springframework.cloud.kubernetes.fabric8.config.Fabric8RetryBootstrapConfiguration;
...
class ConfigMapEnableRetryWithoutFailFastTest {
	...
	@Test
	void doesNotContainRetryableConfigMapPropertySourceLocator() {
