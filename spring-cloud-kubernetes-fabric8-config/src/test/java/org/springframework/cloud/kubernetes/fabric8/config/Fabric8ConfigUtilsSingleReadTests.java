...
class Fabric8ConfigUtilsSingleReadTests {
	...
	void testSecretDataByLabelsTwoSecretsFound() {
		...
		Map<String, Object> secretData = result.data().get("my-secret");
		Assertions.assertThat(secretData.get("property")).isEqualTo("value");

		Map<String, Object> secretData2 = result.data().get("my-secret-2");
	...
	void testSecretDataByLabelsThreeSecretsFound() {
		...
		Map<String, Object> data = result.data().get("blue-circle-secret");
		Assertions.assertThat(data.get("one")).isEqualTo("1");

		Map<String, Object> data2 = result.data().get("blue-square-secret");
