...
class Fabric8ConfigUtilsNamespacedBatchReadTests {
	...
	void testSecretDataByLabelsTwoSecretsFound() {
		...
		@SuppressWarnings("unchecked")
		Map<String, Object> mySecretData2 = (Map<String, Object>) result.data().get("my-secret-2");
	...
	void testSecretDataByLabelsThreeSecretsFound() {
		...
		@SuppressWarnings("unchecked")
		Map<String, Object> dataOne = (Map<String, Object>) result.data().get("blue-circle-secret");
		Assertions.assertThat(dataOne).containsExactlyInAnyOrderEntriesOf(Map.of("one", "1"));

		@SuppressWarnings("unchecked")
		Map<String, Object> dataTwo = (Map<String, Object>) result.data().get("blue-square-secret");
