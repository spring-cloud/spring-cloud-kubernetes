...
package org.springframework.cloud.kubernetes.fabric8.config.name_not_provided;
...
class NameNotProvidedTests {
	...
	static void setUpBeforeClass() {
		...
		Map<String, String> one = Collections.singletonMap("configmap.property", "value");
