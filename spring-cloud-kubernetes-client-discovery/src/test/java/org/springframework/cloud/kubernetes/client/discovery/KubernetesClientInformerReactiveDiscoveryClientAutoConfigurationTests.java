...
class KubernetesClientInformerReactiveDiscoveryClientAutoConfigurationTests {
	...
	void kubernetesDiscoveryClientCreated() {
		...
		assertThat(composite.getDiscoveryClients()
			.stream()
			.anyMatch(dc -> dc instanceof KubernetesClientInformerReactiveDiscoveryClient)).isTrue();
	}
