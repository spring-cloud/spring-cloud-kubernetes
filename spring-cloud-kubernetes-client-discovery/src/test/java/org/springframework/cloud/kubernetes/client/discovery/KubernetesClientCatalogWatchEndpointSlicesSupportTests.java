...
class KubernetesClientCatalogWatchEndpointSlicesSupportTests {
	...
	void testEndpointSlicesEnabledButNotSupported() {
		...
		KubernetesClientCatalogWatch watch = new KubernetesClientCatalogWatch(null, apiClient, properties,
	...
	void testEndpointsSupport() {
		...
		Assertions.assertThat(watch.stateGenerator().getClass()).isEqualTo(KubernetesClientEndpointsCatalogWatch.class);
	}
	...
	void testEndpointSlicesSupport() {
		...
		KubernetesClientCatalogWatch watch = new KubernetesClientCatalogWatch(null, apiClient, properties,
				NAMESPACE_PROVIDER, APPLICATION_EVENT_PUBLISHER);
		Assertions.assertThat(watch.stateGenerator().getClass())
			.isEqualTo(KubernetesClientEndpointSlicesCatalogWatch.class);
	}
