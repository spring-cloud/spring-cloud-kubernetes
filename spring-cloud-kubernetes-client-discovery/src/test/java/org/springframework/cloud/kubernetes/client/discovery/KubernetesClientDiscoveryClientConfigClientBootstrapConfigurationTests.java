...
public class KubernetesClientDiscoveryClientConfigClientBootstrapConfigurationTests {
	...
	private void setup(String... env) {
		...
		parent.register(UtilAutoConfiguration.class, PropertyPlaceholderAutoConfiguration.class,
				...
				KubernetesClientAutoConfiguration.class, KubernetesClientInformerDiscoveryClientAutoConfiguration.class,
	...
	protected static class EnvironmentKnobbler {
		...
		@Bean
		KubernetesClientInformerDiscoveryClient kubernetesInformerDiscoveryClient() {
			KubernetesClientInformerDiscoveryClient client = mock(KubernetesClientInformerDiscoveryClient.class);
