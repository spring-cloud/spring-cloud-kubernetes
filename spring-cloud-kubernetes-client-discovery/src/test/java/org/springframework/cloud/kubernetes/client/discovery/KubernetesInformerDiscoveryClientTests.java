...
public class KubernetesInformerDiscoveryClientTests {
	...
	public void testDiscoveryGetServicesAllNamespaceShouldWork() {
		...
		KubernetesDiscoveryProperties properties = new KubernetesDiscoveryProperties(
			true, true, true, 60, false, null, Set.of(), Map.of(), null, null, 0
		);

		KubernetesInformerDiscoveryClient discoveryClient = new KubernetesInformerDiscoveryClient("",
				sharedInformerFactory, serviceLister, null, null, null, properties);
	...
	public void testDiscoveryWithServiceLabels() {
		...
		KubernetesDiscoveryProperties properties = new KubernetesDiscoveryProperties(
			true, true, true, 60, false, null, Set.of(), labels, null, null, 0
		);
	...
	public void testDiscoveryInstancesWithServiceLabels() {
		...
		KubernetesInformerDiscoveryClient discoveryClient = new KubernetesInformerDiscoveryClient("",
				sharedInformerFactory, serviceLister, endpointsLister, null, null, properties);
	...
	public void testDiscoveryGetServicesOneNamespaceShouldWork() {
		...
		KubernetesDiscoveryProperties properties = new KubernetesDiscoveryProperties(
			true, false, true, 60, false, null, Set.of(), Map.of(), null, null, 0
		);
	...
	public void testDiscoveryGetInstanceWithNotReadyAddressesIncludedShouldWork() {
		...
		KubernetesDiscoveryProperties properties = new KubernetesDiscoveryProperties(
			true, false, true, 60, true, null, Set.of(), Map.of(), null, null, 0
		);
	...
	public void instanceWithMultiplePortsAndGenericPrimaryPortNameConfiguredShouldWork() {
		...
		KubernetesDiscoveryProperties properties = new KubernetesDiscoveryProperties(
			true, false, true, 60, false, null, Set.of(), Map.of(), "https", null, 0
		);
	...
	public void instanceWithMultiplePortsAndMisconfiguredGenericPrimaryPortNameShouldReturnFirstPortAndLogWarning() {
		...
		KubernetesDiscoveryProperties properties = new KubernetesDiscoveryProperties(
			true, false, true, 60, false, null, Set.of(), Map.of(), "oops", null, 0
		);
