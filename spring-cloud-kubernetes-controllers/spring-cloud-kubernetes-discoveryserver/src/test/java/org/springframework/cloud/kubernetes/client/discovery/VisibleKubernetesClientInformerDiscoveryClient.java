...
public class VisibleKubernetesClientInformerDiscoveryClient extends KubernetesClientInformerDiscoveryClient {
	...
	public VisibleKubernetesClientInformerDiscoveryClient(SharedInformerFactory sharedInformerFactory,
		...
		super(sharedInformerFactory, serviceListers, endpointsListers, serviceInformers, endpointsInformers, properties,
				coreV1Api, predicate);
	}
