...
class ApplicationWithProfileTest {
	...
	private static final V1ConfigMap APPLICATION_SHAPE = new V1ConfigMapBuilder()
		.withMetadata(new V1ObjectMetaBuilder().withName("application-shape").build())
		.addToData("user", "k8s")
		.build();
	...
	private static final V1ConfigMapList CONFIGMAPS = new V1ConfigMapList().addItemsItem(MY_CONFIGMAP)
		...
		.addItemsItem(APPLICATION_SHAPE);
