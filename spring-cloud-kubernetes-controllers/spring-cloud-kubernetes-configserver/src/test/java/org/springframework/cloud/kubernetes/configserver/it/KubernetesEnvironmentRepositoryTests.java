...
class KubernetesEnvironmentRepositoryTests {
	...
	private static final V1ConfigMapList CONFIGMAP_LIST_DEFAULT_NAMESPACE = NativeClientKubernetesFixture.yaml("configmap-default-list.yaml",
			V1ConfigMapList.class);

	private static final V1ConfigMapList CONFIGMAP_LIST_DEV_NAMESPACE = NativeClientKubernetesFixture.yaml("configmap-dev-list.yaml",
			V1ConfigMapList.class);

	private static final V1SecretList SECRET_LIST_DEFAULT_NAMESPACE = NativeClientKubernetesFixture.yaml("secret-one-list.yaml",
			V1SecretList.class);

	private static final V1ConfigMapList CONFIGMAP_ONE_LIST = NativeClientKubernetesFixture.yaml("configmap-one-list.yaml",
			V1ConfigMapList.class);
