 ...
 * @author wind57
 */
class Fabric8DiscoveryClientServiceLabelsFilteringTests extends Fabric8DiscoveryClientServiceLabelsFiltering {
	...
	void namespaceARedLabels() {
		...
		Fabric8DiscoveryClient discoveryClient = createAndStartListers(namespaces, discoveryProperties);
