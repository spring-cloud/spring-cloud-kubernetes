 ...
 * @author Tim Ysewyn
 */
class Fabric8DiscoveryClientAutoConfigurationPropertiesTests {
	...
	void kubernetesDiscoveryDisabled() {
		...
		assertThat(context.getBeanNamesForType(Fabric8DiscoveryClient.class)).isEmpty();
	}
	...
	void kubernetesDiscoveryDefaultEnabled() {
		...
		assertThat(context.getBeanNamesForType(Fabric8DiscoveryClient.class)).hasSize(1);
	}
	...
	private void setup(String... env) {
		...
		context = new SpringApplicationBuilder(PropertyPlaceholderAutoConfiguration.class,
				KubernetesClientTestConfiguration.class, Fabric8DiscoveryClientAutoConfiguration.class,
