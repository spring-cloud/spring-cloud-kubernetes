...
/**
 * Test various conditionals for {@link Fabric8DiscoveryClientAutoConfiguration}
 *
 * @author wind57
 */
class Fabric8DiscoveryClientAutoConfigurationApplicationContextTests {
	...
	private void setupWithFilteredClassLoader(Class<?> cls, String... properties) {
		applicationContextRunner = new ApplicationContextRunner()
			.withConfiguration(AutoConfigurations.of(Fabric8DiscoveryClientAutoConfiguration.class,
