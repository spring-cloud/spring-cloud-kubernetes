...
class Fabric8CatalogWatchTest {
	...
	private Fabric8CatalogWatch kubernetesCatalogWatch;
	...
	private void createInAllNamespaceWatcher() {
		...
		kubernetesCatalogWatch = new Fabric8CatalogWatch(CLIENT, properties, namespaceProvider,
