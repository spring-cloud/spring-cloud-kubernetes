 ...
 * @author Tim Ysewyn
 */
class Fabric8CatalogServicesWatchConfigurationTest {
	...
	void kubernetesCatalogWatchDefaultEnabled() {
		...
		assertThat(context.containsBean("fabric8CatalogWatch")).isTrue();
	}
	...
	private void setup(String... env) {
		...
		context = new SpringApplicationBuilder(PropertyPlaceholderAutoConfiguration.class,
				KubernetesClientTestConfiguration.class, Fabric8CatalogWatchAutoConfiguration.class,
