...
final class Fabric8InstanceIdHostPodNameSupplier implements Supplier<InstanceIdHostPodName> {
	 ...
	 */
	static Fabric8InstanceIdHostPodNameSupplier fabric8InstanceIdHostPodNameSupplier(EndpointAddress endpointAddress,
			Service service) {
	 ...
	 * to be used when .spec.type of the Service is == 'ExternalName'.
	 */
	static Fabric8InstanceIdHostPodNameSupplier fabric8InstanceIdHostPodNameSupplier(Service service) {
