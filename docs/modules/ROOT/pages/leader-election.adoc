...
Events have been renamed in the new implementation ( to closely match the native listeners ), so they have become `NewLeaderEvent`, `StartLeadingEvent` and `StopLeadingEvent`.
