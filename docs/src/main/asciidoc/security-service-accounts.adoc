...
For development purposes, you can add `cluster-reader` permissions to your `default` service account. On a productive system you'll want to provide more granular permissions.
