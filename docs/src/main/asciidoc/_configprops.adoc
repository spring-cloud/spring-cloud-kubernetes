...
|spring.cloud.kubernetes.config.retry.initial-interval | `+++1000+++` | 
|spring.cloud.kubernetes.config.retry.max-attempts | `+++6+++` | 
|spring.cloud.kubernetes.config.retry.max-interval | `+++2000+++` | 
|spring.cloud.kubernetes.config.retry.multiplier | `+++1.1+++` | 
...
|spring.cloud.kubernetes.secrets.retry.initial-interval | `+++1000+++` | 
|spring.cloud.kubernetes.secrets.retry.max-attempts | `+++6+++` | 
|spring.cloud.kubernetes.secrets.retry.max-interval | `+++2000+++` | 
|spring.cloud.kubernetes.secrets.retry.multiplier | `+++1.1+++` | 
