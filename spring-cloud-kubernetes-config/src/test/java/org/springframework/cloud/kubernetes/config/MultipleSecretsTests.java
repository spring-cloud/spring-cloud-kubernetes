...
import org.springframework.cloud.kubernetes.config.example3.Example3App;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = Example3App.class, properties = {
