...
public class KubernetesServiceServerListTest {
	...
	public static void setUpBefore() {
		...
		// Configured, mock a service with 2 ports, named 'otherPort50002' and
		// 'expectedPort50001'
		server.expect().get().withPath("/api/v1/namespaces/testns/services/testapp")
				.andReturn(200, new ServiceBuilder().withNewMetadata().withName("testapp")
						...
						.addToSelector("app", "testapp-a").addNewPort()
						.withName("otherPort50002").withPort(50002)
						.withTargetPort(new IntOrString(50002)).withProtocol("TCP")
						.endPort().addNewPort().withName("expectedPort50001")
						.withPort(50001).withTargetPort(new IntOrString(50001))
	...
	public void testGetServicesServerList() throws Exception {
		...
		KubernetesServicesServerList servicesServerList = new KubernetesServicesServerList(
				mockClient, new KubernetesRibbonProperties());
		...
		// means we need all request send to the only port which is set in
		// 'ribbon.PortName'
