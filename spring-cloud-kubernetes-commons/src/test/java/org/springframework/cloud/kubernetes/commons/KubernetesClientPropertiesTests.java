...
class KubernetesClientPropertiesTests {
	...
	void testNonDefaults() {
		new ApplicationContextRunner().withUserConfiguration(Config.class)
			.withPropertyValues("spring.cloud.kubernetes.client.trust-certs=true",
					"spring.cloud.kubernetes.client.master-url=master-url",
					"spring.cloud.kubernetes.client.api-version=1",
					...
					"spring.cloud.kubernetes.client.username=username",
					"spring.cloud.kubernetes.client.password=password",
					...
					"spring.cloud.kubernetes.client.user-agent=user-agent")
			.run(context -> {
				KubernetesClientProperties properties = context.getBean(KubernetesClientProperties.class);
				assertThat(properties).isNotNull();
