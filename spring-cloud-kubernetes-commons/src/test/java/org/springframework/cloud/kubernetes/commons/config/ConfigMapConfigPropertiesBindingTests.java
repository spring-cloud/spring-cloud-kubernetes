	...
	void testWithNonDefaults() {
		new ApplicationContextRunner()
			...
			.withPropertyValues(
				...
				"spring.cloud.kubernetes.config.paths[0]=a",
				"spring.cloud.kubernetes.config.paths[1]=b",
				...
				"spring.cloud.kubernetes.config.name=name",
				...
				"spring.cloud.kubernetes.config.retry-properties.initial-interval=1",
				"spring.cloud.kubernetes.config.retry-properties.multiplier=1.2",
				"spring.cloud.kubernetes.config.retry-properties.max-interval=3",
				"spring.cloud.kubernetes.config.retry-properties.max-attempts=4",
				"spring.cloud.kubernetes.config.retry-properties.enabled=false"
			)
			.run(context -> {
				ConfigMapConfigProperties props = context.getBean(ConfigMapConfigProperties.class);
				Assertions.assertNotNull(props);
